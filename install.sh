...
printf "  ${DIM}-----------------------------------------------${RESET}\n"
echo "  Claude Code --- OTLP ---."
echo "                           +--> warden-collector --> SQLite"
echo "  hooks --------- UDS ----'          |"
echo "                               .-----+------."
echo "                               |     |      |"
echo "                          statusline viewer  API"
echo "                          context%   :8477"
echo ""
printf "  ${DIM}db: $COLLECTOR_STATE_DIR/collector.db${RESET}\n"
printf "  ${DIM}    sessions, spans, hook events, budgets${RESET}\n"
printf "  ${DIM}    starts automatically, stops when idle${RESET}\n"
