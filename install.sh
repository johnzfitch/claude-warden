...
printf "      ${DIM}|${RESET}\n"
printf "      ${DIM}|${RESET}--${CYAN}OTLP (HTTP/JSON)${RESET}${DIM}-----------------------------------.${RESET}\n"
printf "      ${DIM}|                                                      |${RESET}\n"
...
printf "      ${DIM}|       |${RESET}               ${DIM}(Go binary)${RESET}              ${CYAN}receiver${RESET}\n"
printf "      ${DIM}|       v                   |                          |${RESET}\n"
printf "      ${DIM}|${RESET}  ${DIM}[tool runs]${RESET}              ${DIM}v${RESET}                          ${DIM}|${RESET}\n"
printf "      ${DIM}|       |${RESET}           ${CYAN}collector.sock${RESET} ${DIM}(UDS)${RESET}               ${DIM}|${RESET}\n"
printf "      ${DIM}|       v                   |                          |${RESET}\n"
printf "      ${DIM}|${RESET}  ${GREEN}PostToolUse${RESET}              ${DIM}v${RESET}                          ${DIM}|${RESET}\n"
printf "      ${DIM}|       |${RESET}          ${DIM}.---${RESET}${BOLD}${YELLOW}collector.db${RESET} ${DIM}(SQLite)-----.     |${RESET}\n"
printf "      ${DIM}|       v          |                             |     |${RESET}\n"
printf "      ${DIM}|${RESET}  ${GREEN}SessionEnd${RESET}      ${DIM}|${RESET}  ${YELLOW}sessions${RESET}      ${YELLOW}hook_events${RESET}  ${DIM}|<---'${RESET}\n"
printf "      ${DIM}|${RESET}                  ${DIM}|${RESET}  ${YELLOW}spans${RESET}          ${YELLOW}subagent_budgets${RESET}\n"
printf "      ${DIM}|${RESET}                  ${DIM}|${RESET}  ${YELLOW}token counts${RESET}   ${YELLOW}budget-deny files${RESET}\n"
printf "      ${DIM}|                  '-------|---------------------'${RESET}\n"
printf "      ${DIM}|                          |${RESET}\n"
printf "      ${DIM}|                    .-----+------.${RESET}\n"
printf "      ${DIM}|                    |            |${RESET}\n"
...
printf "  ${DIM}(context %%)${RESET}         ${DIM}(:8477)${RESET}      ${DIM}/v1/sessions${RESET}\n"
echo ""
